...
direct_declarator : identifier_ { $$ = $1; printf( "IDENTY%s", $1 ); }
                  | structype_ { $$ = $1; printf( "SIDENTY" ); }// | declaration_specifiers structype_ semicolon { printf( "SIDENTY%s", $1 ); } // moved from direct_declarator
