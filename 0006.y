...
function_definition : declarator compound_statement { printf( "definition" ); }
                    | declarator declaration_list compound_statement { printf( "initialized" ); }
                    | declaration_specifiers declarator compound_statement { $$ = $2; printf( "declaratordef" ); }
                    | declaration_specifiers declarator declaration_list compound_statement { $$ = $2; printf( "declaratordef" ); }
                    ;
...
struct_declarator_list : struct_declarator
                       ...
                       | struct_declarator_list comma attributes struct_declarator
                       ;

struct_declarator : declarator { printf( "STRUCT" ); }
                  | declarator attributes
                  | colon constant_expression
                  | colon constant_expression attributes
...
direct_declarator : identifier_ { printf( "IDENTY%s", $1 ); }
                  | structype_ { printf( "SIDENTY" ); }// | declaration_specifiers structype_ semicolon { printf( "SIDENTY%s", $1 ); } // moved from direct_declarator
